...
const team: TeamMember[] = [
  {
    ...
    bio: 'The eye behind the lens. A visual storyteller who built After90 from a belief that African sport deserves world-class imagery, with every frame made with intent and every photo earning its place.',
    glowX: '25%',
    glowY: '30%',
